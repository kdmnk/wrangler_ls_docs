...
% Document's metadata
\title{Implementing the Language Server Protocol in the Wrangler Erlang refactoring tool} % title
\date{2022} % year of defense

% Author's metadata
\author{Dominik Katkó}
...
\todo{ERLEF, Erlang LS, H., supervisors}
